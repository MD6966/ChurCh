        ...
        <>
            ...
            >
                ...
                <Box sx={{
                    ...
                    <Typography sx={{ fontSize: '32px', fontWeight: 600, position: 'relative' }}>
                        <FormatQuoteIcon
                            sx={{ display: isSmall ? 'none' : '', position: 'absolute', top: '-50px', left: '50%', transform: 'translateX(-50%)', fontSize: '3rem', color: 'rgba(255, 255, 255, 0.8)' }}
                        />
